...
val LightGrey = Color(0xFF919094)
val SearchColor = Color(0xFF28272E)

val BlackNote = Color(0xFF1C1B1F)
val RedNote = Color(0xFF6D202E)
val BrownNote = Color(0xFF622E1D)
val OrangeNote = Color(0xFF764C18)
val GreenNote = Color(0xFF2F4B3D)